      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            ...
            style: FilledButton.styleFrom(backgroundColor: StorageTokens.dangerStrong),
  ...
  Future<void> _editNonClothingItem(Map<String, dynamic> item) async {
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Update item details',
              style: TextStyle(fontSize: 13, color: StorageTokens.muted),
            ),
                ...
                Expanded(
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      foregroundColor: StorageTokens.slate,
                      side: const BorderSide(color: StorageTokens.line),
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        ...
        backgroundColor: StorageTokens.success,
      ),
    );
    _load();
  }
        ...
        body: Stack(
          children: [
                            ...
                            if (_selectionMode) ...[
                              ...
                              FilledButton.icon(
                                ...
                                style: FilledButton.styleFrom(
                                  backgroundColor: StorageTokens.dangerStrong,
                                ),
                              ),
                            ] else
                              OutlinedButton.icon(
            ...
            if (_movingItem)
              Positioned.fill(
                child: Container(
                  color: StorageTokens.black.withValues(alpha: 0.26),
                  alignment: Alignment.center,
